...

{
  "expo": {
    ...
    "plugins": [
      [
        "@mapsindoors/react-native-maps-indoors-google-maps/app.plugin.js", // plugin ref
        { "apiKey": "API_KEY" }
      ]
    ]
  }
...
import MapsIndoors, { MapControl, MapView, MPMapConfig } from "@mapsindoors/react-native-maps-indoors-google-maps";
...
